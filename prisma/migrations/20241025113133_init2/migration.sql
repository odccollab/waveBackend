/*
  ...
  - You are about to drop the `ContenuMedia` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "ContenuMedia" DROP CONSTRAINT "ContenuMedia_userId_fkey";
